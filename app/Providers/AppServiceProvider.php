        ...
        View::composer(['threads.index', 'threads.show'], function($view) {
            ...
            if (auth()->check())
                $menu->push(
                    ...
                    [
                        'query' => '?contributed',
                        'isActive' => request()->has('contributed'),
                        'order' => 3,
                        'svg' => '
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" class="mr-4 fill-current">
                                <g fill-rule="nonzero">
                                    <path d="M16.571 10.636a.476.476 0 0 1-.476.478l-2.385.006a.476.476 0 0 1-.002-.954l2.385-.006c.264 0 .478.212.478.476M15.814 8.017a.477.477 0 0 1-.227.636l-2.154 1.023a.476.476 0 0 1-.41-.863l2.155-1.022a.477.477 0 0 1 .636.226M15.828 13.259a.477.477 0 0 0-.229-.635l-2.16-1.012a.476.476 0 1 0-.405.863l2.16 1.013c.238.112.523.01.634-.23M12.823 6.686c-.678-.2-1.285-.738-1.497-1.073-.362-.576.075-.726-.073-2.333C11.118 1.81 9.093.228 6.63.067 5.512-.006 4.348.223 3.155.875.092 2.55-1.122 6.09 1.244 9.509c2.132 3.082.132 4.474.132 4.474s.079.649 1.39 1.521c1.311.872 2.92.28 2.92.28s.53-1.886 2.265-1.712c1.244.183 2.99-.061 3.43-.489.414-.399-.072-.9.258-2.015-1.129-.11-1.748-.648-1.808-1.406 1.252.122 1.768-.276 2.126-.713a49.53 49.53 0 0 0-.06-1.171c1.107-.32 1.531-1.413.926-1.592"></path>
                                </g>
                            </svg>
                        ',
